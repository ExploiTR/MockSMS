    ...
    private void markMmsFailed(final Context context) {
        ...
        try {
            ...
            BroadcastUtils.sendExplicitBroadcast(
                    mContext, new Intent(), "com.klinker.android.send_message.REFRESH");
            BroadcastUtils.sendExplicitBroadcast(
                    mContext,
                    new Intent(),
                    "com.moez.QKSMS.NOTIFY_SMS_FAILURE");

            // broadcast that mms has failed and you can notify user from there if you would like
            BroadcastUtils.sendExplicitBroadcast(
                    mContext, new Intent(), "com.klinker.android.send_message.MMS_ERROR");
        } catch (Exception e) {
        }
    }
